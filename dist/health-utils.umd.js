(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var OSS = /** @class */ (function () {
        ...
        OSS.prototype.getPolicy = function (ext) {
            if (ext === void 0) { ext = ''; }
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            query = ext ? "?ext=" + ext : '';
                            return [4 /*yield*/, this.net.fetch({ url: "/health/foundation/osspolicy" + query })];
                        case 1:
                            response = _a.sent();
        ...
        OSS.prototype.upload = function (file, policy) {
            return __awaiter(this, void 0, void 0, function () {
                var formData;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, fetch(policy.host, {
                                    method: 'POST',
                                    body: formData
                                })];
                        case 1:
    ...
    var HealthImage = /** @class */ (function () {
        function HealthImage(file) {
            this.file = file;
        }
        HealthImage.prototype.fixIOSRotate = function () {
            return __awaiter(this, void 0, void 0, function () {
                var orientation_1, image, canvas, context, dataUri, err_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
                            return [4 /*yield*/, this.getTag('Orientation')];
                        case 1:
                        ...
                        case 2:
                            ...
                            console.log('File Orientation', orientation_1);
                            switch (Number(orientation_1)) {
                                case 2:
                            ...
                            return [2 /*return*/, this.dataUriToFile(dataUri)];
                        case 3:
                            err_1 = _a.sent();
                            console.error('fixIOSRotate 异常：', err_1);
        ...
        HealthImage.prototype.getImage = function () {
            var _this = this;
        ...
        HealthImage.prototype.getTag = function (tag) {
            var _this = this;
            return new Promise(function (resole) {
        ...
        HealthImage.prototype.dataUriToFile = function (dataUri) {
            var byteString;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            heImage = new HealthImage(file);
                            return [4 /*yield*/, heImage.fixIOSRotate()];
                        case 1:
                            file = _a.sent();
                            _a.label = 2;
                        case 2:
                            fileType = fileTypes.find(function (_a) {
                                var type = _a.type;
...
//# sourceMappingURL=health-utils.umd.js.map
